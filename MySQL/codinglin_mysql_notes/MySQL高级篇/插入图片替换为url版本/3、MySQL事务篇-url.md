...
![image-20220708124306444](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708124306444.png)
...
![image-20220708164610193](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708164610193.png)
...
* **提交的（committed）**
  ...
  <img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708171859055.png" alt="image-20220708171859055" style="zoom:80%;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708201221316.png" alt="image-20220708201221316" style="float:left;" />
...
![image-20220708214453902](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708214453902.png)
...
![image-20220708215109480](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708215109480.png)
...
![image-20220708215626435](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708215626435.png)
...
![image-20220708220102342](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708220102342.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708220228436.png" alt="image-20220708220228436" style="float:left;" />
...
![image-20220708220917267](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708220917267.png)

`脏写 `怎么没涉及到？因为脏写这个问题太严重了，不论是哪种隔离级别，都不允许脏写的情况发生。

不同的隔离级别有不同的现象，并有不同的锁和并发机制，隔离级别越高，数据库的并发性能就越差，4 种事务隔离级别与并发性能的关系如下：

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708220957108.png" alt="image-20220708220957108" style="zoom:80%;" />

### 3.4 MySQL支持的四种隔离级别

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708221639979.png" alt="image-20220708221639979" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220708223250773.png" alt="image-20220708223250773" style="float:left;" />

**演示1. 读未提交之脏读**

设置隔离级别为未提交读：

![image-20220710193920008](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710193920008.png)

脏读就是指当前事务就在访问数据，并且对数据进行了修改，而这种修改还没有提交到数据库中，这时，另外一个事务也访问了这个数据，然后使用了这个数据。

**演示2：读已提交**

![image-20220710194440101](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710194440101.png)

**演示3. 不可重复读**

设置隔离级别为可重复读，事务的执行流程如下：

![image-20220710194144826](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710194144826.png)

当我们将当前会话的隔离级别设置为可重复读的时候，当前会话可以重复读，就是每次读取的结果集都相同，而不管其他事务有没有提交。但是在可重复读的隔离级别上会出现幻读的问题。

**演示4：幻读**

![image-20220710194042096](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710194042096.png)

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710194612317.png" alt="image-20220710194612317" style="float:left;" />
...
![image-20220710202517977](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710202517977.png)
...
![image-20220710204114543](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710204114543.png)
...
![image-20220710204427616](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710204427616.png)
...
![image-20220710205015302](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710205015302.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710205948156.png" alt="image-20220710205948156" style="float:left;" />

另外，InnoDB存储引擎有一个后台线程，每隔`1秒`，就会把`redo log buffer`中的内容写到文件系统缓存(`page cache`)，然后调用刷盘操作。

![image-20220710210339724](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710210339724.png)

也就是说，一个没有提交事务的`redo log`记录，也可能会刷盘。因为在事务执行过程 redo log 记录是会写入 `redo log buffer`中，这些redo log 记录会被`后台线程`刷盘。

![image-20220710210532805](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710210532805.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710210751414.png" alt="image-20220710210751414" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710211318120.png" alt="image-20220710211318120" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710211335379.png" alt="image-20220710211335379" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710211618789.png" alt="image-20220710211618789" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710211831675.png" alt="image-20220710211831675" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710212041563.png" alt="image-20220710212041563" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710215001482.png" alt="image-20220710215001482" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710215353893.png" alt="image-20220710215353893" style="float:left;" />
...
![image-20220710220653131](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710220653131.png)

#### 2. redo 日志写入log buffer

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710220838744.png" alt="image-20220710220838744" style="float:left;" />

![image-20220710220919271](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710220919271.png)

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710221221981.png" alt="image-20220710221221981" style="float:left;" />

![image-20220710221318271](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710221318271.png)
...
![image-20220710221620291](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710221620291.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710223117420.png" alt="image-20220710223117420" style="float:left;" />

![image-20220710223135374](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220710223135374.png)

真正的redo日志都是存储到占用`496`字节大小的`log block body`中，图中的`log block header`和`log block trailer`存储的是一些管理信息。我们来看看这些所谓`管理信息`都有什么。

![image-20220711144546439](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711144546439.png)

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711144608223.png" alt="image-20220711144608223" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711152137012.png" alt="image-20220711152137012" style="float:left;" />

![image-20220711152242300](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711152242300.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711152930911.png" alt="image-20220711152930911" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711153523704.png" alt="image-20220711153523704" style="float:left;" />

### 2.2 Undo日志的作用

* **作用1：回滚数据**

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711153645204.png" alt="image-20220711153645204" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711154936382.png" alt="image-20220711154936382" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711162414928.png" alt="image-20220711162414928" style="float:left;" />

**只有Buffer Pool的流程：**

![image-20220711162505008](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711162505008.png)

**有了Redo Log和Undo Log之后：**

![image-20220711162642305](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711162642305.png)

在更新Buffer Pool中的数据之前，我们需要先将该数据事务开始之前的状态写入Undo Log中。假设更新到一半出错了，我们就可以通过Undo Log来回滚到事务开始前。

#### 2. 详细生成过程

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711162919157.png" alt="image-20220711162919157" style="float:left;" />
...
![image-20220711163725129](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711163725129.png)
...
![image-20220711164138414](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711164138414.png)
...
![image-20220711164421494](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711164421494.png)
...
![image-20220711165612956](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711165612956.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711165954976.png" alt="image-20220711165954976" style="float:left;" />
...
![image-20220711181120639](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711181120639.png)

当一个事务想对这条记录做改动时，首先会看看内存中有没有与这条记录关联的 `锁结构` ，当没有的时候 就会在内存中生成一个 `锁结构` 与之关联。比如，事务` T1` 要对这条记录做改动，就需要生成一个 `锁结构` 与之关联：

![image-20220711192633239](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711192633239.png)
...
![image-20220711193732567](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711193732567.png)
...
![image-20220711194904328](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711194904328.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711203250284.png" alt="image-20220711203250284" style="float:left;" />
...
![image-20220711203519162](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711203519162.png)

### 3.1 从数据操作的类型划分：读锁、写锁

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711203723941.png" alt="image-20220711203723941" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711204843684.png" alt="image-20220711204843684" style="float:left;" />

#### 1. 锁定读

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711212931912.png" alt="image-20220711212931912" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711213741630.png" alt="image-20220711213741630" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711214013208.png" alt="image-20220711214013208" style="float:left;" />

#### 2. 写操作

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711214412163.png" alt="image-20220711214412163" style="float:left;" />

### 3.2 从数据操作的粒度划分：表级锁、页级锁、行锁

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711214719510.png" alt="image-20220711214719510" style="float:left;" />

#### 1. 表锁（Table Lock）

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711214805088.png" alt="image-20220711214805088" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220342251.png" alt="image-20220711220342251" style="float:left;" />

或者

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220418859.png" alt="image-20220711220418859" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220442269.png" alt="image-20220711220442269" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220502141.png" alt="image-20220711220502141" style="float:left;" />

步骤5：加读锁

我们为mylock表加read锁（读阻塞写），观察阻塞的情况，流程如下：

![image-20220711220553225](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220553225.png)

![image-20220711220616537](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220616537.png)

步骤6：加写锁

为mylock表加write锁，观察阻塞的情况，流程如下：

![image-20220711220711630](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220711630.png)

![image-20220711220730112](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220730112.png)
...
* 表独占写锁（Table Write Lock）
  ...
  ![image-20220711220929248](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711220929248.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220711222132300.png" alt="image-20220711222132300" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220712124209006.png" alt="image-20220712124209006" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220712175552985.png" alt="image-20220712175552985" style="float:left;" />
...
![image-20220713142808924](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713142808924.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713161549241.png" alt="image-20220713161549241" style="float:left;" />

student表中的聚簇索引的简图如下所示。

![image-20220713163353648](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713163353648.png)
...
![image-20220713164811567](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713164811567.png)

举例如下：

![image-20220713164948405](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713164948405.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713174726264.png" alt="image-20220713174726264" style="float:left;" />
...
![image-20220713174108634](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713174108634.png)
...
![image-20220713174551814](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713174551814.png)

![image-20220713174602102](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713174602102.png)

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713175032619.png" alt="image-20220713175032619" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713192418730.png" alt="image-20220713192418730" style="float:left;" />
...
![image-20220713192549340](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713192549340.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713203124889.png" alt="image-20220713203124889" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713203532124.png" alt="image-20220713203532124" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713203619704.png" alt="image-20220713203619704" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713203714577.png" alt="image-20220713203714577" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713204544767.png" alt="image-20220713204544767" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713205010502.png" alt="image-20220713205010502" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713205135694.png" alt="image-20220713205135694" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713210951100.png" alt="image-20220713210951100" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713211139670.png" alt="image-20220713211139670" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713211417909.png" alt="image-20220713211417909" style="float:left;" />

### 3.4 按加锁的方式划分：显式锁、隐式锁

#### 1. 隐式锁

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713211525845.png" alt="image-20220713211525845" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713214522709.png" alt="image-20220713214522709" style="float:left;" />
...
![image-20220713220714098](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713220714098.png)

**举例2：**

用户A给用户B转账100，再次同时，用户B也给用户A转账100。这个过程，可能导致死锁。

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713220936236.png" alt="image-20220713220936236" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713221418100.png" alt="image-20220713221418100" style="float:left;" />
...
![image-20220713221758941](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713221758941.png)

基于这两个信息，可以绘制wait-for graph（等待图）

![image-20220713221830455](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220713221830455.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714131008260.png" alt="image-20220714131008260" style="float:left;" />
...
![image-20220714132306208](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714132306208.png)
...
![image-20220714133319666](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714133319666.png)
...
![image-20220714134603698](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134603698.png)
...
![image-20220714134623052](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134623052-16577775838551.png)
...
![image-20220714134742049](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134742049.png)
...
![image-20220714134822160](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134822160.png)
...
![image-20220714134846740](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134846740.png)
...
![image-20220714134923414](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134923414.png)
...
![image-20220714134945012](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714134945012.png)
...
![image-20220714135007118](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135007118.png)
...
![image-20220714135025045](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135025045-16577778257713.png)
...
![image-20220714135047760](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135047760.png)
...
![image-20220714135130668](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135130668.png)
...
![image-20220714135206504](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135206504.png)
...
![image-20220714135300189](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135300189.png)
...
![image-20220714135333089](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714135333089.png)
...
![image-20220714140441064](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140441064.png)

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140510426.png" alt="image-20220714140510426" style="float:left;" />

![image-20220714140541555](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140541555.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140716427.png" alt="image-20220714140716427" style="float:left;" />

假设插入该记录的`事务id`为`8`，那么此刻该条记录的示意图如下所示：

![image-20220714140801595](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140801595.png)

> insert undo只在事务回滚时起作用，当事务提交后，该类型的undo日志就没用了，它占用的Undo Log Segment也会被系统回收（也就是该undo日志占用的Undo页面链表要么被重用，要么被释放）。

假设之后两个事务id分别为 `10` 、 `20` 的事务对这条记录进行` UPDATE` 操作，操作流程如下：

![image-20220714140846658](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140846658.png)

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714140908661.png" alt="image-20220714140908661" style="float:left;" />

每次对记录进行改动，都会记录一条undo日志，每条undo日志也都有一个 `roll_pointer` 属性 （ `INSERT` 操作对应的undo日志没有该属性，因为该记录并没有更早的版本），可以将这些 `undo日志` 都连起来，串成一个链表：

![image-20220714141012874](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714141012874.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714141154235.png" alt="image-20220714141154235" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220714142254768.png" alt="image-20220714142254768" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715130639408.png" alt="image-20220715130639408" style="float:left;" />

在隔离级别为读已提交（Read Committed）时，一个事务中的每一次 SELECT 查询都会重新获取一次 Read View。

如表所示：

![image-20220715130843147](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715130843147.png)

> 注意，此时同样的查询语句都会重新获取一次 Read View，这时如果 Read View 不同，就可能产生不可重复读或者幻读的情况。

当隔离级别为可重复读的时候，就避免了不可重复读，这是因为一个事务只在第一次 SELECT 的时候会获取一次 Read View，而后面所有的 SELECT 都会复用这个 Read View，如下表所示：

![image-20220715130916437](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715130916437.png)

## 5. 举例说明

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715131200077.png" alt="image-20220715131200077" style="float:left;" />
...
![image-20220715133640655](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715133640655.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715134540737.png" alt="image-20220715134540737" style="float:left;" />
...
![image-20220715134839081](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715134839081.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715135017000.png" alt="image-20220715135017000" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715135143939.png" alt="image-20220715135143939" style="float:left;" />
...
![image-20220715140006061](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715140006061.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715140155744.png" alt="image-20220715140155744" style="float:left;" />
...
![image-20220715140354217](http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715140354217.png)
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715140555172.png" alt="image-20220715140555172" style="float:left;" />

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715140620328.png" alt="image-20220715140620328" style="float:left;" />
...
<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715141413135.png" alt="image-20220715141413135" style="float:left;" />

通过MVCC我们可以解决：

<img src="http://jason243.online/DatabasesNote/MySQL/codinglin_mysql_notes/MySQL事务篇.assets/image-20220715141515370.png" alt="image-20220715141515370" style="float:left;" />
